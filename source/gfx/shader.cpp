...
int Shader::Register(asIScriptEngine *scriptEngine)
{
	...
	r = scriptEngine->RegisterObjectMethod("Shader", "void setSampler2D(const string &in, const Texture @texture)", asMETHODPR(Shader, setSampler2D, (const string&, const Texture*), void), asCALL_THISCALL); AS_ASSERT
